module.exports = {
    ...
    handleUpdateFundraisingEventCostRequest: require('./handle-update-fundraising-event-cost'),
    ...
    handlePauseFundraisingEventRequest: require('./handle-pause-fundraising-event'),
};
