...
function showEndedScreen(data, pageKey) {
    ...
    const viewBoard = document.getElementById('endedViewLeaderboard');
        ...
        if (pageKey) {
            const mid =
                data && isNonEmptyString(data.merchantId)
                    ...
                    : '';
            viewBoard.href = buildCrowdfundingDonorsAllUrl(pageKey, {
